...
class StableScreenshoterTest < ActiveSupport::TestCase
  ...
  def setup
    super
    @manager = SnapDiff::SnapManager.new(SnapDiff.config.root / "stable_screenshoter_test")
  ...
  test "#take_comparison_screenshot raises UnstableImage when stability timeout is reached" do
    ...
    assert_raises SnapDiff::UnstableImage, "Could not get stable screenshot within 1s" do
      SnapDiff::Comparison.stub :new, mock do
